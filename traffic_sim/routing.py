...
class ShortestPathRouter:
    ...
    def __init__(self, net: RoadNetwork, seed: int = 0, demand=None,
        ...
        ``demand`` is an optional time-of-day :class:`~traffic_sim.demand.
        DemandModel`; when given, new destinations come from it (using
        :attr:`now`, the current time the simulation keeps in sync) instead of
